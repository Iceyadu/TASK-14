...
/**
 * Centralised exception handler that translates known exceptions into
 * consistent {@link ApiResponse} error envelopes.
 */
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Void>> handleConcurrentSession(ConcurrentSessionException ex) {
        return ResponseEntity.status(HttpStatus.CONFLICT)
                .body(ApiResponse.error(ex.getMessage()));
    }
